...
#INSTALL_DIR = "C:\Software\arduino-1.0.1"
...
#PORT = /dev/ttyUSB*
INSTALL_DIR = /cygdrive/c/Software/arduino-0018
##arduino-1.0.1
#update this
PORT = "COM12"
UPLOAD_RATE = 57600
...
#on mac use this, not the path below
...
#CINCS = -I$(ARDUINO) $(INSTALL_DIR)
CINCS =  -I$(ARDUINO)  -I$(INSTALL_DIR)/hardware/arduino/cores/arduino
#CINCS =  IC:/Software/arduino-0018/hardware/arduino/cores/arduino  -IC:/Software/arduino-0018/libraries/Wire
#-I$(INSTALL_DIR)/hardware/arduino/cores/arduino/variants/mega 
#$(INSTALL_DIR)/hardware/arduino/cores/arduino
CXXINCS = -I$(ARDUINO) -I$(INSTALL_DIR)/hardware/arduino/cores/arduino 
#-I$(INSTALL_DIR)/hardware/arduino/cores/arduino/variants/mega 
...
applet/$(TARGET).cpp: $(TARGET).pde
	...
	# On top of the new .cpp file comes the make header.
